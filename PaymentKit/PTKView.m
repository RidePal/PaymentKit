...
- (void)setup
{
	...
	//    backgroundImageView.image = [[self imageNamed:@"textfield"]
	...
	//    gradientImageView.image = [self imageNamed:@"gradient"];
...
{
	NSString *path = [[NSBundle bundleForClass:[PTKView class]] pathForResource:name ofType:@"png"];
...
- (void)setupPlaceholderView
{
	...
	self.placeholderView.image = [self imageNamed:@"placeholder"];
...
- (void)setPlaceholderToCVC
{
	...
	if (cardType == PTKCardTypeAmex) {
		[self setPlaceholderViewImage:[self imageNamed:@"cvc-amex"]];
	} else {
		[self setPlaceholderViewImage:[self imageNamed:@"cvc"]];
	}
}
...
- (void)setPlaceholderToCardType
{
	...
	[self setPlaceholderViewImage:[self imageNamed:cardTypeName]];
}
